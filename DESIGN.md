...
- **Peinture procédurale** : chaque décor est peint au démarrage à partir de milliers de coups de pinceau « à poils » (plusieurs traits fins parallèles et courbés), sur des aplats de couleur, avec grain et vignettage. Le rendu vise les esquisses à l'huile de Rostov, sans en copier une seule.
...
- **Son** : vent filtré, glace qui « chante » (les sifflements descendants des lacs gelés), cloches, et une petite valse en mineur jouée étouffée.
