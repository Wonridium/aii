...
- **Scènes 3D peintes** : chaque lieu (25 décors) est modélisé en Three.js à partir de volumes simples (cabanes sur patins, lustre de glace, corps sous la glace, chapelle-tente, usine, bains de vapeur, cuisine du rêve…), éclairé par des lanternes et du brouillard, puis passé dans un filtre de peinture à l'huile : filtre de Kuwahara (qui fond les détails en aplats comme une brosse), bords ondulés, texture de toile et de coups de pinceau, étalonnage chaud/froid, vignettage. Le but : qu'on reconnaisse immédiatement ce qui est représenté, tout en gardant l'impression d'une esquisse de Rostov. La caméra respire lentement ; neige, flammes et vapeur bougent.
...
- **Musique** : une pièce générative par lieu, toutes construites autour d'un même motif (« l'aubade ») : cordes pincées et vent pour la glace, valse d'accordéon étouffée derrière les murs du dancing (qui passe au mineur pressé quand le dégel commence), orgue et chœur pour la chapelle, boîte à musique pour l'atelier de couture, piano électrique et contrebasse pour les bains, violoncelle et timbales pour l'effondrement, et une version majeure de l'aubade pour l'aube.
- **Voix intérieures** : dans *Disco Elysium: The Final Cut*, un seul comédien (Lenval Brown) prête sa voix grave et rocailleuse à toutes les compétences ; c'est ce qui fait qu'on les entend comme les morceaux d'une seule tête. *Candle Ice* reprend ce principe : une même voix de narrateur, très grave et granuleuse, déclinée en quatre humeurs selon l'attribut. Les morts ont d'autres voix, traitées comme si elles venaient de l'eau ou de la glace. Les répliques des personnages vivants restent à lire, comme les choix du joueur.
